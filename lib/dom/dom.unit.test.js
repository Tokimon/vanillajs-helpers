  ...
  describe('dom.class', function() {
    ...
    describe('add', function() {
      ...
      it('should be able to add a several class names separated by space (" "), to an element', function() {
        dom.class.add(div, 'test more');
        expect(div.className).to.equal('test more');

        dom.class.add(div, 'even more');
    ...
    describe('remove', function() {
      ...
      it('should be able to remove a several class names separated by space (" "), from an element', function() {
        div.className = 'test remove';
        dom.class.remove(div, 'test remove');
        expect(div.className).to.equal('');

        div.className = 'test remove more more';
        dom.class.remove(div, 'remove more');
        expect(div.className).to.equal('test');
      });
    });
    ...
    describe('has', function() {
      ...
      it('Should toggle a list of classnames', function() {
        ...
        dom.class.toggle(div, 'class2 class3 class4');
        expect(dom.class.has(div, 'test class1 class2 class4')).to.be.true;

        dom.class.toggle(div, 'class1 class2 class4');
        expect(dom.class.has(div, 'test')).to.be.true;

        dom.class.toggle(div, 'class1 class2 class3 class4');
        expect(dom.class.has(div, 'test class1 class2 class3 class4')).to.be.true;
      });
    });
  });
